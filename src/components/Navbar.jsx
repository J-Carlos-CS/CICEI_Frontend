...
import { 
    ...
    SettingsOutlined, 
    ArrowDropDownCircleOutlined } from '@mui/icons-material'
import FlexBetween from 'components/FlexBetween'
import { useDispatch } from 'react-redux'
import { setMode } from 'state'
import ImagePerfil from "assets/ImagePerfil.jpg";
import { AppBar, useTheme,Toolbar, IconButton, InputBase, Icon, Button, Box, Typography, Menu, MenuItem } from '@mui/material'
const Navbar = ({
    user,
    isSidebarOpen,
    setIsSidebarOpen
