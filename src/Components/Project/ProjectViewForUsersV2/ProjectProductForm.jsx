...
export default function ProjectProductForm({
  ...
  const onFinish = async (values) => {
    ...
    let create = productTarget?.id ? false : true;
    await handleOk(product, create, setRequesting);
  };
        ...
        >
          ...
          >
            {activities.map((a) => (
              ...
              >
                {a.Product ? `Producto ya registrado para - ${a.name}` : a.name}
              </Select.Option>
            ))}
          </Select>
        </Form.Item>
